...
public class BQInterestRetrieveOutputModelInterestInstanceRecordInterestRateConfiguration   {
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The interest rate value to be applied (note could be variable) 
   * @return interestRate
  **/
